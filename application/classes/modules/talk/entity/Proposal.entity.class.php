...
class ModuleTalk_EntityProposal extends EntityORM{
   ...
   protected $aValidateRules = [];
    ...
    public function __construct() {
        $this->aValidateRules =  array(
            ...
            array(
                ...
                'min' => 10, 
                'allowEmpty' => false,
                'msg' => $this->Lang_Get('talk.proposal.form.text.error_validate', ['min' => 10, 'max' => 200])
            ),
            array(
                'text', 
                'double_text'
    ...
    public function ValidateDoubleText($sValue) {
        ...
        if($this->Talk_GetProposalByFilter([
            'text' => $sParseText,
            'target_id' => $this->getTargetId(),
            'user_id' => $this->getUserId()
        ])){
            return $this->Lang_Get('talk.proposal.notice.error_double_text');
        }
